...
instance Bif_ Erlang_abs where bif_ arity _ = Import "erlang" "abs" arity ;{-# INLINE bif_ #-}

data Erlang_adler32 = Erlang_adler32
instance NoGC Erlang_adler32
instance Bif1 Erlang_adler32
instance Bif2 Erlang_adler32
instance Bif_ Erlang_adler32 where bif_ arity _ = Import "erlang" "adler32" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_adler32_combine where bif_ arity _ = Import "erlang" "adler32_combine" arity ;{-# INLINE bif_ #-}

data Erlang_apply = Erlang_apply
instance NoGC Erlang_apply
instance Bif3 Erlang_apply
instance Bif_ Erlang_apply where bif_ arity _ = Import "erlang" "apply" arity ;{-# INLINE bif_ #-}

data Erlang_atom_to_list = Erlang_atom_to_list
instance NoGC Erlang_atom_to_list
instance Bif1 Erlang_atom_to_list
instance Bif_ Erlang_atom_to_list where bif_ arity _ = Import "erlang" "atom_to_list" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_binary_to_list where bif_ arity _ = Import "erlang" "binary_to_list" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_external_size where bif_ arity _ = Import "erlang" "external_size" arity ;{-# INLINE bif_ #-}

data Erlang_float = Erlang_float
instance Bif1 Erlang_float
instance Bif_ Erlang_float where bif_ arity _ = Import "erlang" "float" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_float_to_list where bif_ arity _ = Import "erlang" "float_to_list" arity ;{-# INLINE bif_ #-}

data Erlang_fun_info = Erlang_fun_info
instance NoGC Erlang_fun_info
instance Bif2 Erlang_fun_info
instance Bif_ Erlang_fun_info where bif_ arity _ = Import "erlang" "fun_info" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_garbage_collect where bif_ arity _ = Import "erts_internal" "garbage_collect" arity ;{-# INLINE bif_ #-}

data Erlang_get = Erlang_get
instance NoGC Erlang_get
instance Bif0 Erlang_get
instance Bif1 Erlang_get
instance Bif_ Erlang_get where bif_ arity _ = Import "erlang" "get" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_get_keys where bif_ arity _ = Import "erlang" "get_keys" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_group_leader where bif_ arity _ = Import "erlang" "group_leader" arity ;{-# INLINE bif_ #-}

data Erlang_halt = Erlang_halt
instance NoGC Erlang_halt
instance Bif2 Erlang_halt
instance Bif_ Erlang_halt where bif_ arity _ = Import "erlang" "halt" arity ;{-# INLINE bif_ #-}

data Erlang_phash = Erlang_phash
instance NoGC Erlang_phash
instance Bif2 Erlang_phash
instance Bif_ Erlang_phash where bif_ arity _ = Import "erlang" "phash" arity ;{-# INLINE bif_ #-}

data Erlang_phash2 = Erlang_phash2
instance NoGC Erlang_phash2
instance Bif1 Erlang_phash2
instance Bif2 Erlang_phash2
instance Bif_ Erlang_phash2 where bif_ arity _ = Import "erlang" "phash2" arity ;{-# INLINE bif_ #-}

data Erlang_hd = Erlang_hd
instance NoGC Erlang_hd
instance Bif1 Erlang_hd
instance Bif_ Erlang_hd where bif_ arity _ = Import "erlang" "hd" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_integer_to_list where bif_ arity _ = Import "erlang" "integer_to_list" arity ;{-# INLINE bif_ #-}

data Erlang_is_alive = Erlang_is_alive
instance NoGC Erlang_is_alive
instance Bif0 Erlang_is_alive
instance Bif_ Erlang_is_alive where bif_ arity _ = Import "erlang" "is_alive" arity ;{-# INLINE bif_ #-}

data Erlang_length = Erlang_length
instance Bif1 Erlang_length
instance Bif_ Erlang_length where bif_ arity _ = Import "erlang" "length" arity ;{-# INLINE bif_ #-}

data Erlang_link = Erlang_link
instance NoGC Erlang_link
instance Bif1 Erlang_link
instance Bif_ Erlang_link where bif_ arity _ = Import "erlang" "link" arity ;{-# INLINE bif_ #-}

data Erlang_list_to_atom = Erlang_list_to_atom
instance NoGC Erlang_list_to_atom
instance Bif1 Erlang_list_to_atom
instance Bif_ Erlang_list_to_atom where bif_ arity _ = Import "erlang" "list_to_atom" arity ;{-# INLINE bif_ #-}

data Erlang_list_to_binary = Erlang_list_to_binary
instance NoGC Erlang_list_to_binary
instance Bif1 Erlang_list_to_binary
instance Bif_ Erlang_list_to_binary where bif_ arity _ = Import "erlang" "list_to_binary" arity ;{-# INLINE bif_ #-}

data Erlang_list_to_float = Erlang_list_to_float
instance NoGC Erlang_list_to_float
instance Bif1 Erlang_list_to_float
instance Bif_ Erlang_list_to_float where bif_ arity _ = Import "erlang" "list_to_float" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_list_to_integer where bif_ arity _ = Import "erlang" "list_to_integer" arity ;{-# INLINE bif_ #-}

data Erlang_list_to_pid = Erlang_list_to_pid
instance NoGC Erlang_list_to_pid
instance Bif1 Erlang_list_to_pid
instance Bif_ Erlang_list_to_pid where bif_ arity _ = Import "erlang" "list_to_pid" arity ;{-# INLINE bif_ #-}

data Erlang_list_to_port = Erlang_list_to_port
instance NoGC Erlang_list_to_port
instance Bif1 Erlang_list_to_port
instance Bif_ Erlang_list_to_port where bif_ arity _ = Import "erlang" "list_to_port" arity ;{-# INLINE bif_ #-}

data Erlang_list_to_ref = Erlang_list_to_ref
instance NoGC Erlang_list_to_ref
instance Bif1 Erlang_list_to_ref
instance Bif_ Erlang_list_to_ref where bif_ arity _ = Import "erlang" "list_to_ref" arity ;{-# INLINE bif_ #-}

data Erlang_list_to_tuple = Erlang_list_to_tuple
instance NoGC Erlang_list_to_tuple
instance Bif1 Erlang_list_to_tuple
instance Bif_ Erlang_list_to_tuple where bif_ arity _ = Import "erlang" "list_to_tuple" arity ;{-# INLINE bif_ #-}

data Erlang_loaded = Erlang_loaded
instance NoGC Erlang_loaded
instance Bif0 Erlang_loaded
instance Bif_ Erlang_loaded where bif_ arity _ = Import "erlang" "loaded" arity ;{-# INLINE bif_ #-}

data Erlang_localtime = Erlang_localtime
instance NoGC Erlang_localtime
instance Bif0 Erlang_localtime
instance Bif_ Erlang_localtime where bif_ arity _ = Import "erlang" "localtime" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_localtime_to_universaltime where bif_ arity _ = Import "erlang" "localtime_to_universaltime" arity ;{-# INLINE bif_ #-}

data Erlang_make_ref = Erlang_make_ref
instance NoGC Erlang_make_ref
instance Bif0 Erlang_make_ref
instance Bif_ Erlang_make_ref where bif_ arity _ = Import "erlang" "make_ref" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_unique_integer where bif_ arity _ = Import "erlang" "unique_integer" arity ;{-# INLINE bif_ #-}

data Erlang_md5 = Erlang_md5
instance NoGC Erlang_md5
instance Bif1 Erlang_md5
instance Bif_ Erlang_md5 where bif_ arity _ = Import "erlang" "md5" arity ;{-# INLINE bif_ #-}

data Erlang_md5_init = Erlang_md5_init
instance NoGC Erlang_md5_init
instance Bif0 Erlang_md5_init
instance Bif_ Erlang_md5_init where bif_ arity _ = Import "erlang" "md5_init" arity ;{-# INLINE bif_ #-}

data Erlang_md5_update = Erlang_md5_update
instance NoGC Erlang_md5_update
instance Bif2 Erlang_md5_update
instance Bif_ Erlang_md5_update where bif_ arity _ = Import "erlang" "md5_update" arity ;{-# INLINE bif_ #-}

data Erlang_md5_final = Erlang_md5_final
instance NoGC Erlang_md5_final
instance Bif1 Erlang_md5_final
instance Bif_ Erlang_md5_final where bif_ arity _ = Import "erlang" "md5_final" arity ;{-# INLINE bif_ #-}

data Erlang_module_loaded = Erlang_module_loaded
instance NoGC Erlang_module_loaded
instance Bif1 Erlang_module_loaded
instance Bif_ Erlang_module_loaded where bif_ arity _ = Import "erlang" "module_loaded" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_function_exported where bif_ arity _ = Import "erlang" "function_exported" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_monitor_node where bif_ arity _ = Import "erlang" "monitor_node" arity ;{-# INLINE bif_ #-}

data Erlang_node = Erlang_node
instance NoGC Erlang_node
instance Bif0 Erlang_node
instance Bif1 Erlang_node
instance Bif_ Erlang_node where bif_ arity _ = Import "erlang" "node" arity ;{-# INLINE bif_ #-}

data Erlang_nodes = Erlang_nodes
instance NoGC Erlang_nodes
instance Bif1 Erlang_nodes
instance Bif_ Erlang_nodes where bif_ arity _ = Import "erlang" "nodes" arity ;{-# INLINE bif_ #-}

data Erlang_now = Erlang_now
instance NoGC Erlang_now
instance Bif0 Erlang_now
instance Bif_ Erlang_now where bif_ arity _ = Import "erlang" "now" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_monotonic_time where bif_ arity _ = Import "erlang" "monotonic_time" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_system_time where bif_ arity _ = Import "erlang" "system_time" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_time_offset where bif_ arity _ = Import "erlang" "time_offset" arity ;{-# INLINE bif_ #-}

data Erlang_timestamp = Erlang_timestamp
instance NoGC Erlang_timestamp
instance Bif0 Erlang_timestamp
instance Bif_ Erlang_timestamp where bif_ arity _ = Import "erlang" "timestamp" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_open_port where bif_ arity _ = Import "erts_internal" "open_port" arity ;{-# INLINE bif_ #-}

data Erlang_pid_to_list = Erlang_pid_to_list
instance NoGC Erlang_pid_to_list
instance Bif1 Erlang_pid_to_list
instance Bif_ Erlang_pid_to_list where bif_ arity _ = Import "erlang" "pid_to_list" arity ;{-# INLINE bif_ #-}

data Erlang_ports = Erlang_ports
instance NoGC Erlang_ports
instance Bif0 Erlang_ports
instance Bif_ Erlang_ports where bif_ arity _ = Import "erlang" "ports" arity ;{-# INLINE bif_ #-}

data Erlang_pre_loaded = Erlang_pre_loaded
instance NoGC Erlang_pre_loaded
instance Bif0 Erlang_pre_loaded
instance Bif_ Erlang_pre_loaded where bif_ arity _ = Import "erlang" "pre_loaded" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_process_flag where bif_ arity _ = Import "erlang" "process_flag" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_process_info where bif_ arity _ = Import "erlang" "process_info" arity ;{-# INLINE bif_ #-}

data Erlang_processes = Erlang_processes
instance NoGC Erlang_processes
instance Bif0 Erlang_processes
instance Bif_ Erlang_processes where bif_ arity _ = Import "erlang" "processes" arity ;{-# INLINE bif_ #-}

data Erlang_put = Erlang_put
instance NoGC Erlang_put
instance Bif2 Erlang_put
instance Bif_ Erlang_put where bif_ arity _ = Import "erlang" "put" arity ;{-# INLINE bif_ #-}

data Erlang_register = Erlang_register
instance NoGC Erlang_register
instance Bif2 Erlang_register
instance Bif_ Erlang_register where bif_ arity _ = Import "erlang" "register" arity ;{-# INLINE bif_ #-}

data Erlang_registered = Erlang_registered
instance NoGC Erlang_registered
instance Bif0 Erlang_registered
instance Bif_ Erlang_registered where bif_ arity _ = Import "erlang" "registered" arity ;{-# INLINE bif_ #-}

data Erlang_round = Erlang_round
instance Bif1 Erlang_round
instance Bif_ Erlang_round where bif_ arity _ = Import "erlang" "round" arity ;{-# INLINE bif_ #-}

data Erlang_self = Erlang_self
instance NoGC Erlang_self
instance Bif0 Erlang_self
instance Bif_ Erlang_self where bif_ arity _ = Import "erlang" "self" arity ;{-# INLINE bif_ #-}

data Erlang_setelement = Erlang_setelement
instance NoGC Erlang_setelement
instance Bif3 Erlang_setelement
instance Bif_ Erlang_setelement where bif_ arity _ = Import "erlang" "setelement" arity ;{-# INLINE bif_ #-}

data Erlang_size = Erlang_size
instance Bif1 Erlang_size
instance Bif_ Erlang_size where bif_ arity _ = Import "erlang" "size" arity ;{-# INLINE bif_ #-}

data Erlang_spawn = Erlang_spawn
instance NoGC Erlang_spawn
instance Bif3 Erlang_spawn
instance Bif_ Erlang_spawn where bif_ arity _ = Import "erlang" "spawn" arity ;{-# INLINE bif_ #-}

data Erlang_spawn_link = Erlang_spawn_link
instance NoGC Erlang_spawn_link
instance Bif3 Erlang_spawn_link
instance Bif_ Erlang_spawn_link where bif_ arity _ = Import "erlang" "spawn_link" arity ;{-# INLINE bif_ #-}

data Erlang_split_binary = Erlang_split_binary
instance NoGC Erlang_split_binary
instance Bif2 Erlang_split_binary
instance Bif_ Erlang_split_binary where bif_ arity _ = Import "erlang" "split_binary" arity ;{-# INLINE bif_ #-}

data Erlang_statistics = Erlang_statistics
instance NoGC Erlang_statistics
instance Bif1 Erlang_statistics
instance Bif_ Erlang_statistics where bif_ arity _ = Import "erlang" "statistics" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_term_to_binary where bif_ arity _ = Import "erlang" "term_to_binary" arity ;{-# INLINE bif_ #-}

data Erlang_throw = Erlang_throw
instance NoGC Erlang_throw
instance Bif1 Erlang_throw
instance Bif_ Erlang_throw where bif_ arity _ = Import "erlang" "throw" arity ;{-# INLINE bif_ #-}

data Erlang_time = Erlang_time
instance NoGC Erlang_time
instance Bif0 Erlang_time
instance Bif_ Erlang_time where bif_ arity _ = Import "erlang" "time" arity ;{-# INLINE bif_ #-}

data Erlang_tl = Erlang_tl
instance NoGC Erlang_tl
instance Bif1 Erlang_tl
instance Bif_ Erlang_tl where bif_ arity _ = Import "erlang" "tl" arity ;{-# INLINE bif_ #-}

data Erlang_trunc = Erlang_trunc
instance Bif1 Erlang_trunc
instance Bif_ Erlang_trunc where bif_ arity _ = Import "erlang" "trunc" arity ;{-# INLINE bif_ #-}

data Erlang_tuple_to_list = Erlang_tuple_to_list
instance NoGC Erlang_tuple_to_list
instance Bif1 Erlang_tuple_to_list
instance Bif_ Erlang_tuple_to_list where bif_ arity _ = Import "erlang" "tuple_to_list" arity ;{-# INLINE bif_ #-}

data Erlang_universaltime = Erlang_universaltime
instance NoGC Erlang_universaltime
instance Bif0 Erlang_universaltime
instance Bif_ Erlang_universaltime where bif_ arity _ = Import "erlang" "universaltime" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_universaltime_to_localtime where bif_ arity _ = Import "erlang" "universaltime_to_localtime" arity ;{-# INLINE bif_ #-}

data Erlang_unlink = Erlang_unlink
instance NoGC Erlang_unlink
instance Bif1 Erlang_unlink
instance Bif_ Erlang_unlink where bif_ arity _ = Import "erlang" "unlink" arity ;{-# INLINE bif_ #-}

data Erlang_unregister = Erlang_unregister
instance NoGC Erlang_unregister
instance Bif1 Erlang_unregister
instance Bif_ Erlang_unregister where bif_ arity _ = Import "erlang" "unregister" arity ;{-# INLINE bif_ #-}

data Erlang_whereis = Erlang_whereis
instance NoGC Erlang_whereis
instance Bif1 Erlang_whereis
instance Bif_ Erlang_whereis where bif_ arity _ = Import "erlang" "whereis" arity ;{-# INLINE bif_ #-}

data Erlang_spawn_opt = Erlang_spawn_opt
instance NoGC Erlang_spawn_opt
instance Bif1 Erlang_spawn_opt
instance Bif_ Erlang_spawn_opt where bif_ arity _ = Import "erlang" "spawn_opt" arity ;{-# INLINE bif_ #-}

data Erlang_setnode = Erlang_setnode
instance NoGC Erlang_setnode
instance Bif2 Erlang_setnode
instance Bif3 Erlang_setnode
instance Bif_ Erlang_setnode where bif_ arity _ = Import "erlang" "setnode" arity ;{-# INLINE bif_ #-}

data Erlang_dist_get_stat = Erlang_dist_get_stat
instance NoGC Erlang_dist_get_stat
instance Bif1 Erlang_dist_get_stat
instance Bif_ Erlang_dist_get_stat where bif_ arity _ = Import "erlang" "dist_get_stat" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_input_handler where bif_ arity _ = Import "erlang" "dist_ctrl_input_handler" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_put_data where bif_ arity _ = Import "erlang" "dist_ctrl_put_data" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_get_data where bif_ arity _ = Import "erlang" "dist_ctrl_get_data" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_get_data_notification where bif_ arity _ = Import "erlang" "dist_ctrl_get_data_notification" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_info where bif_ arity _ = Import "erts_internal" "port_info" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_call where bif_ arity _ = Import "erts_internal" "port_call" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_command where bif_ arity _ = Import "erts_internal" "port_command" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_control where bif_ arity _ = Import "erts_internal" "port_control" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_close where bif_ arity _ = Import "erts_internal" "port_close" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_connect where bif_ arity _ = Import "erts_internal" "port_connect" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_request_system_task where bif_ arity _ = Import "erts_internal" "request_system_task" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_check_process_code where bif_ arity _ = Import "erts_internal" "check_process_code" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_map_to_tuple_keys where bif_ arity _ = Import "erts_internal" "map_to_tuple_keys" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_term_type where bif_ arity _ = Import "erts_internal" "term_type" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_map_hashmap_children where bif_ arity _ = Import "erts_internal" "map_hashmap_children" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_time_unit where bif_ arity _ = Import "erts_internal" "time_unit" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_perf_counter_unit where bif_ arity _ = Import "erts_internal" "perf_counter_unit" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_is_system_process where bif_ arity _ = Import "erts_internal" "is_system_process" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_system_check where bif_ arity _ = Import "erts_internal" "system_check" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_release_literal_area_switch where bif_ arity _ = Import "erts_internal" "release_literal_area_switch" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_scheduler_wall_time where bif_ arity _ = Import "erts_internal" "scheduler_wall_time" arity ;{-# INLINE bif_ #-}

data Erlang_port_set_data = Erlang_port_set_data
instance NoGC Erlang_port_set_data
instance Bif2 Erlang_port_set_data
instance Bif_ Erlang_port_set_data where bif_ arity _ = Import "erlang" "port_set_data" arity ;{-# INLINE bif_ #-}

data Erlang_port_get_data = Erlang_port_get_data
instance NoGC Erlang_port_get_data
instance Bif1 Erlang_port_get_data
instance Bif_ Erlang_port_get_data where bif_ arity _ = Import "erlang" "port_get_data" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_trace_pattern where bif_ arity _ = Import "erts_internal" "trace_pattern" arity ;{-# INLINE bif_ #-}

data Erts_internal_trace = Erts_internal_trace
instance NoGC Erts_internal_trace
instance Bif3 Erts_internal_trace
instance Bif_ Erts_internal_trace where bif_ arity _ = Import "erts_internal" "trace" arity ;{-# INLINE bif_ #-}

data Erlang_trace_info = Erlang_trace_info
instance NoGC Erlang_trace_info
instance Bif2 Erlang_trace_info
instance Bif_ Erlang_trace_info where bif_ arity _ = Import "erlang" "trace_info" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_trace_delivered where bif_ arity _ = Import "erlang" "trace_delivered" arity ;{-# INLINE bif_ #-}

data Erlang_seq_trace = Erlang_seq_trace
instance NoGC Erlang_seq_trace
instance Bif2 Erlang_seq_trace
instance Bif_ Erlang_seq_trace where bif_ arity _ = Import "erlang" "seq_trace" arity ;{-# INLINE bif_ #-}

data Erlang_seq_trace_info = Erlang_seq_trace_info
instance NoGC Erlang_seq_trace_info
instance Bif1 Erlang_seq_trace_info
instance Bif_ Erlang_seq_trace_info where bif_ arity _ = Import "erlang" "seq_trace_info" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_seq_trace_print where bif_ arity _ = Import "erlang" "seq_trace_print" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_suspend_process where bif_ arity _ = Import "erlang" "suspend_process" arity ;{-# INLINE bif_ #-}

data Erlang_resume_process = Erlang_resume_process
instance NoGC Erlang_resume_process
instance Bif1 Erlang_resume_process
instance Bif_ Erlang_resume_process where bif_ arity _ = Import "erlang" "resume_process" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_process_display where bif_ arity _ = Import "erlang" "process_display" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_bump_reductions where bif_ arity _ = Import "erlang" "bump_reductions" arity ;{-# INLINE bif_ #-}

data Math_cos = Math_cos
instance NoGC Math_cos
instance Bif1 Math_cos
instance Bif_ Math_cos where bif_ arity _ = Import "math" "cos" arity ;{-# INLINE bif_ #-}

data Math_cosh = Math_cosh
instance NoGC Math_cosh
instance Bif1 Math_cosh
instance Bif_ Math_cosh where bif_ arity _ = Import "math" "cosh" arity ;{-# INLINE bif_ #-}

data Math_sin = Math_sin
instance NoGC Math_sin
instance Bif1 Math_sin
instance Bif_ Math_sin where bif_ arity _ = Import "math" "sin" arity ;{-# INLINE bif_ #-}

data Math_sinh = Math_sinh
instance NoGC Math_sinh
instance Bif1 Math_sinh
instance Bif_ Math_sinh where bif_ arity _ = Import "math" "sinh" arity ;{-# INLINE bif_ #-}

data Math_tan = Math_tan
instance NoGC Math_tan
instance Bif1 Math_tan
instance Bif_ Math_tan where bif_ arity _ = Import "math" "tan" arity ;{-# INLINE bif_ #-}

data Math_tanh = Math_tanh
instance NoGC Math_tanh
instance Bif1 Math_tanh
instance Bif_ Math_tanh where bif_ arity _ = Import "math" "tanh" arity ;{-# INLINE bif_ #-}

data Math_acos = Math_acos
instance NoGC Math_acos
instance Bif1 Math_acos
instance Bif_ Math_acos where bif_ arity _ = Import "math" "acos" arity ;{-# INLINE bif_ #-}

data Math_acosh = Math_acosh
instance NoGC Math_acosh
instance Bif1 Math_acosh
instance Bif_ Math_acosh where bif_ arity _ = Import "math" "acosh" arity ;{-# INLINE bif_ #-}

data Math_asin = Math_asin
instance NoGC Math_asin
instance Bif1 Math_asin
instance Bif_ Math_asin where bif_ arity _ = Import "math" "asin" arity ;{-# INLINE bif_ #-}

data Math_asinh = Math_asinh
instance NoGC Math_asinh
instance Bif1 Math_asinh
instance Bif_ Math_asinh where bif_ arity _ = Import "math" "asinh" arity ;{-# INLINE bif_ #-}

data Math_atan = Math_atan
instance NoGC Math_atan
instance Bif1 Math_atan
instance Bif_ Math_atan where bif_ arity _ = Import "math" "atan" arity ;{-# INLINE bif_ #-}

data Math_atanh = Math_atanh
instance NoGC Math_atanh
instance Bif1 Math_atanh
instance Bif_ Math_atanh where bif_ arity _ = Import "math" "atanh" arity ;{-# INLINE bif_ #-}

data Math_erf = Math_erf
instance NoGC Math_erf
instance Bif1 Math_erf
instance Bif_ Math_erf where bif_ arity _ = Import "math" "erf" arity ;{-# INLINE bif_ #-}

data Math_erfc = Math_erfc
instance NoGC Math_erfc
instance Bif1 Math_erfc
instance Bif_ Math_erfc where bif_ arity _ = Import "math" "erfc" arity ;{-# INLINE bif_ #-}

data Math_exp = Math_exp
instance NoGC Math_exp
instance Bif1 Math_exp
instance Bif_ Math_exp where bif_ arity _ = Import "math" "exp" arity ;{-# INLINE bif_ #-}

data Math_log = Math_log
instance NoGC Math_log
instance Bif1 Math_log
instance Bif_ Math_log where bif_ arity _ = Import "math" "log" arity ;{-# INLINE bif_ #-}

data Math_log2 = Math_log2
instance NoGC Math_log2
instance Bif1 Math_log2
instance Bif_ Math_log2 where bif_ arity _ = Import "math" "log2" arity ;{-# INLINE bif_ #-}

data Math_log10 = Math_log10
instance NoGC Math_log10
instance Bif1 Math_log10
instance Bif_ Math_log10 where bif_ arity _ = Import "math" "log10" arity ;{-# INLINE bif_ #-}

data Math_sqrt = Math_sqrt
instance NoGC Math_sqrt
instance Bif1 Math_sqrt
instance Bif_ Math_sqrt where bif_ arity _ = Import "math" "sqrt" arity ;{-# INLINE bif_ #-}

data Math_atan2 = Math_atan2
instance NoGC Math_atan2
instance Bif2 Math_atan2
instance Bif_ Math_atan2 where bif_ arity _ = Import "math" "atan2" arity ;{-# INLINE bif_ #-}

data Math_pow = Math_pow
instance NoGC Math_pow
instance Bif2 Math_pow
instance Bif_ Math_pow where bif_ arity _ = Import "math" "pow" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_start_timer where bif_ arity _ = Import "erlang" "start_timer" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_send_after where bif_ arity _ = Import "erlang" "send_after" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_cancel_timer where bif_ arity _ = Import "erlang" "cancel_timer" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_read_timer where bif_ arity _ = Import "erlang" "read_timer" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_make_tuple where bif_ arity _ = Import "erlang" "make_tuple" arity ;{-# INLINE bif_ #-}

data Erlang_append_element = Erlang_append_element
instance NoGC Erlang_append_element
instance Bif2 Erlang_append_element
instance Bif_ Erlang_append_element where bif_ arity _ = Import "erlang" "append_element" arity ;{-# INLINE bif_ #-}

data Erlang_system_flag = Erlang_system_flag
instance NoGC Erlang_system_flag
instance Bif2 Erlang_system_flag
instance Bif_ Erlang_system_flag where bif_ arity _ = Import "erlang" "system_flag" arity ;{-# INLINE bif_ #-}

data Erlang_system_info = Erlang_system_info
instance NoGC Erlang_system_info
instance Bif1 Erlang_system_info
instance Bif_ Erlang_system_info where bif_ arity _ = Import "erlang" "system_info" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_system_monitor where bif_ arity _ = Import "erlang" "system_monitor" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_system_profile where bif_ arity _ = Import "erlang" "system_profile" arity ;{-# INLINE bif_ #-}

data Erlang_ref_to_list = Erlang_ref_to_list
instance NoGC Erlang_ref_to_list
instance Bif1 Erlang_ref_to_list
instance Bif_ Erlang_ref_to_list where bif_ arity _ = Import "erlang" "ref_to_list" arity ;{-# INLINE bif_ #-}

data Erlang_port_to_list = Erlang_port_to_list
instance NoGC Erlang_port_to_list
instance Bif1 Erlang_port_to_list
instance Bif_ Erlang_port_to_list where bif_ arity _ = Import "erlang" "port_to_list" arity ;{-# INLINE bif_ #-}

data Erlang_fun_to_list = Erlang_fun_to_list
instance NoGC Erlang_fun_to_list
instance Bif1 Erlang_fun_to_list
instance Bif_ Erlang_fun_to_list where bif_ arity _ = Import "erlang" "fun_to_list" arity ;{-# INLINE bif_ #-}

data Erlang_monitor = Erlang_monitor
instance NoGC Erlang_monitor
instance Bif2 Erlang_monitor
instance Bif_ Erlang_monitor where bif_ arity _ = Import "erlang" "monitor" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_demonitor where bif_ arity _ = Import "erlang" "demonitor" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_ebif_plusplus_2 where bif_ arity _ = Import "erlang" "++" arity ;{-# INLINE bif_ #-}

data Erlang_append = Erlang_append
instance NoGC Erlang_append
instance Bif2 Erlang_append
instance Bif_ Erlang_append where bif_ arity _ = Import "erlang" "append" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_ebif_minusminus_2 where bif_ arity _ = Import "erlang" "--" arity ; {-# INLINE bif_ #-}

data Erlang_subtract = Erlang_subtract
instance NoGC Erlang_subtract
instance Bif2 Erlang_subtract
instance Bif_ Erlang_subtract where bif_ arity _ = Import "erlang" "subtract" arity ;{-# INLINE bif_ #-}

data Erlang_is_atom = Erlang_is_atom
instance NoGC Erlang_is_atom
instance Bif1 Erlang_is_atom
instance Bif_ Erlang_is_atom where bif_ arity _ = Import "erlang" "is_atom" arity ;{-# INLINE bif_ #-}

data Erlang_is_list = Erlang_is_list
instance NoGC Erlang_is_list
instance Bif1 Erlang_is_list
instance Bif_ Erlang_is_list where bif_ arity _ = Import "erlang" "is_list" arity ;{-# INLINE bif_ #-}

data Erlang_is_tuple = Erlang_is_tuple
instance NoGC Erlang_is_tuple
instance Bif1 Erlang_is_tuple
instance Bif_ Erlang_is_tuple where bif_ arity _ = Import "erlang" "is_tuple" arity ;{-# INLINE bif_ #-}

data Erlang_is_float = Erlang_is_float
instance NoGC Erlang_is_float
instance Bif1 Erlang_is_float
instance Bif_ Erlang_is_float where bif_ arity _ = Import "erlang" "is_float" arity ;{-# INLINE bif_ #-}

data Erlang_is_integer = Erlang_is_integer
instance NoGC Erlang_is_integer
instance Bif1 Erlang_is_integer
instance Bif_ Erlang_is_integer where bif_ arity _ = Import "erlang" "is_integer" arity ;{-# INLINE bif_ #-}

data Erlang_is_number = Erlang_is_number
instance NoGC Erlang_is_number
instance Bif1 Erlang_is_number
instance Bif_ Erlang_is_number where bif_ arity _ = Import "erlang" "is_number" arity ;{-# INLINE bif_ #-}

data Erlang_is_pid = Erlang_is_pid
instance NoGC Erlang_is_pid
instance Bif1 Erlang_is_pid
instance Bif_ Erlang_is_pid where bif_ arity _ = Import "erlang" "is_pid" arity ;{-# INLINE bif_ #-}

data Erlang_is_port = Erlang_is_port
instance NoGC Erlang_is_port
instance Bif1 Erlang_is_port
instance Bif_ Erlang_is_port where bif_ arity _ = Import "erlang" "is_port" arity ;{-# INLINE bif_ #-}

data Erlang_is_reference = Erlang_is_reference
instance NoGC Erlang_is_reference
instance Bif1 Erlang_is_reference
instance Bif_ Erlang_is_reference where bif_ arity _ = Import "erlang" "is_reference" arity ;{-# INLINE bif_ #-}

data Erlang_is_binary = Erlang_is_binary
instance NoGC Erlang_is_binary
instance Bif1 Erlang_is_binary
instance Bif_ Erlang_is_binary where bif_ arity _ = Import "erlang" "is_binary" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_is_function where bif_ arity _ = Import "erlang" "is_function" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_is_record where bif_ arity _ = Import "erlang" "is_record" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_match_spec_test where bif_ arity _ = Import "erlang" "match_spec_test" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_internal_request_all where bif_ arity _ = Import "ets" "internal_request_all" arity ;{-# INLINE bif_ #-}

data Ets_new = Ets_new
instance NoGC Ets_new
instance Bif2 Ets_new
instance Bif_ Ets_new where bif_ arity _ = Import "ets" "new" arity ;{-# INLINE bif_ #-}

data Ets_delete = Ets_delete
instance NoGC Ets_delete
instance Bif1 Ets_delete
instance Bif2 Ets_delete
instance Bif_ Ets_delete where bif_ arity _ = Import "ets" "delete" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_delete_all_objects where bif_ arity _ = Import "ets" "delete_all_objects" arity ;{-# INLINE bif_ #-}

data Ets_delete_object = Ets_delete_object
instance NoGC Ets_delete_object
instance Bif2 Ets_delete_object
instance Bif_ Ets_delete_object where bif_ arity _ = Import "ets" "delete_object" arity ;{-# INLINE bif_ #-}

data Ets_first = Ets_first
instance NoGC Ets_first
instance Bif1 Ets_first
instance Bif_ Ets_first where bif_ arity _ = Import "ets" "first" arity ;{-# INLINE bif_ #-}

data Ets_is_compiled_ms = Ets_is_compiled_ms
instance NoGC Ets_is_compiled_ms
instance Bif1 Ets_is_compiled_ms
instance Bif_ Ets_is_compiled_ms where bif_ arity _ = Import "ets" "is_compiled_ms" arity ;{-# INLINE bif_ #-}

data Ets_lookup = Ets_lookup
instance NoGC Ets_lookup
instance Bif2 Ets_lookup
instance Bif_ Ets_lookup where bif_ arity _ = Import "ets" "lookup" arity ;{-# INLINE bif_ #-}

data Ets_lookup_element = Ets_lookup_element
instance NoGC Ets_lookup_element
instance Bif3 Ets_lookup_element
instance Bif_ Ets_lookup_element where bif_ arity _ = Import "ets" "lookup_element" arity ;{-# INLINE bif_ #-}

data Ets_info = Ets_info
instance NoGC Ets_info
instance Bif1 Ets_info
instance Bif2 Ets_info
instance Bif_ Ets_info where bif_ arity _ = Import "ets" "info" arity ;{-# INLINE bif_ #-}

data Ets_last = Ets_last
instance NoGC Ets_last
instance Bif1 Ets_last
instance Bif_ Ets_last where bif_ arity _ = Import "ets" "last" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_match where bif_ arity _ = Import "ets" "match" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_match_object where bif_ arity _ = Import "ets" "match_object" arity ;{-# INLINE bif_ #-}

data Ets_member = Ets_member
instance NoGC Ets_member
instance Bif2 Ets_member
instance Bif_ Ets_member where bif_ arity _ = Import "ets" "member" arity ;{-# INLINE bif_ #-}

data Ets_next = Ets_next
instance NoGC Ets_next
instance Bif2 Ets_next
instance Bif_ Ets_next where bif_ arity _ = Import "ets" "next" arity ;{-# INLINE bif_ #-}

data Ets_prev = Ets_prev
instance NoGC Ets_prev
instance Bif2 Ets_prev
instance Bif_ Ets_prev where bif_ arity _ = Import "ets" "prev" arity ;{-# INLINE bif_ #-}

data Ets_insert = Ets_insert
instance NoGC Ets_insert
instance Bif2 Ets_insert
instance Bif_ Ets_insert where bif_ arity _ = Import "ets" "insert" arity ;{-# INLINE bif_ #-}

data Ets_insert_new = Ets_insert_new
instance NoGC Ets_insert_new
instance Bif2 Ets_insert_new
instance Bif_ Ets_insert_new where bif_ arity _ = Import "ets" "insert_new" arity ;{-# INLINE bif_ #-}

data Ets_rename = Ets_rename
instance NoGC Ets_rename
instance Bif2 Ets_rename
instance Bif_ Ets_rename where bif_ arity _ = Import "ets" "rename" arity ;{-# INLINE bif_ #-}

data Ets_safe_fixtable = Ets_safe_fixtable
instance NoGC Ets_safe_fixtable
instance Bif2 Ets_safe_fixtable
instance Bif_ Ets_safe_fixtable where bif_ arity _ = Import "ets" "safe_fixtable" arity ;{-# INLINE bif_ #-}

data Ets_slot = Ets_slot
instance NoGC Ets_slot
instance Bif2 Ets_slot
instance Bif_ Ets_slot where bif_ arity _ = Import "ets" "slot" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_update_counter where bif_ arity _ = Import "ets" "update_counter" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_select where bif_ arity _ = Import "ets" "select" arity ;{-# INLINE bif_ #-}

data Ets_select_count = Ets_select_count
instance NoGC Ets_select_count
instance Bif2 Ets_select_count
instance Bif_ Ets_select_count where bif_ arity _ = Import "ets" "select_count" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_select_reverse where bif_ arity _ = Import "ets" "select_reverse" arity ;{-# INLINE bif_ #-}

data Ets_select_delete = Ets_select_delete
instance NoGC Ets_select_delete
instance Bif2 Ets_select_delete
instance Bif_ Ets_select_delete where bif_ arity _ = Import "ets" "select_delete" arity ;{-# INLINE bif_ #-}

data Ets_select_replace = Ets_select_replace
instance NoGC Ets_select_replace
instance Bif2 Ets_select_replace
instance Bif_ Ets_select_replace where bif_ arity _ = Import "ets" "select_replace" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_match_spec_compile where bif_ arity _ = Import "ets" "match_spec_compile" arity ;{-# INLINE bif_ #-}

data Ets_match_spec_run_r = Ets_match_spec_run_r
instance NoGC Ets_match_spec_run_r
instance Bif3 Ets_match_spec_run_r
instance Bif_ Ets_match_spec_run_r where bif_ arity _ = Import "ets" "match_spec_run_r" arity ;{-# INLINE bif_ #-}

data Os_get_env_var = Os_get_env_var
instance NoGC Os_get_env_var
instance Bif1 Os_get_env_var
instance Bif_ Os_get_env_var where bif_ arity _ = Import "os" "get_env_var" arity ;{-# INLINE bif_ #-}

data Os_set_env_var = Os_set_env_var
instance NoGC Os_set_env_var
instance Bif2 Os_set_env_var
instance Bif_ Os_set_env_var where bif_ arity _ = Import "os" "set_env_var" arity ;{-# INLINE bif_ #-}

data Os_unset_env_var = Os_unset_env_var
instance NoGC Os_unset_env_var
instance Bif1 Os_unset_env_var
instance Bif_ Os_unset_env_var where bif_ arity _ = Import "os" "unset_env_var" arity ;{-# INLINE bif_ #-}

data Os_list_env_vars = Os_list_env_vars
instance NoGC Os_list_env_vars
instance Bif0 Os_list_env_vars
instance Bif_ Os_list_env_vars where bif_ arity _ = Import "os" "list_env_vars" arity ;{-# INLINE bif_ #-}

data Os_getpid = Os_getpid
instance NoGC Os_getpid
instance Bif0 Os_getpid
instance Bif_ Os_getpid where bif_ arity _ = Import "os" "getpid" arity ;{-# INLINE bif_ #-}

data Os_timestamp = Os_timestamp
instance NoGC Os_timestamp
instance Bif0 Os_timestamp
instance Bif_ Os_timestamp where bif_ arity _ = Import "os" "timestamp" arity ;{-# INLINE bif_ #-}

data Os_system_time = Os_system_time
instance NoGC Os_system_time
instance Bif0 Os_system_time
instance Bif1 Os_system_time
instance Bif_ Os_system_time where bif_ arity _ = Import "os" "system_time" arity ;{-# INLINE bif_ #-}

data Os_perf_counter = Os_perf_counter
instance NoGC Os_perf_counter
instance Bif0 Os_perf_counter
instance Bif_ Os_perf_counter where bif_ arity _ = Import "os" "perf_counter" arity ;{-# INLINE bif_ #-}

data Erl_ddll_try_load = Erl_ddll_try_load
instance NoGC Erl_ddll_try_load
instance Bif3 Erl_ddll_try_load
instance Bif_ Erl_ddll_try_load where bif_ arity _ = Import "erl_ddll" "try_load" arity ;{-# INLINE bif_ #-}

data Erl_ddll_try_unload = Erl_ddll_try_unload
instance NoGC Erl_ddll_try_unload
instance Bif2 Erl_ddll_try_unload
instance Bif_ Erl_ddll_try_unload where bif_ arity _ = Import "erl_ddll" "try_unload" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erl_ddll_loaded_drivers where bif_ arity _ = Import "erl_ddll" "loaded_drivers" arity ;{-# INLINE bif_ #-}

data Erl_ddll_info = Erl_ddll_info
instance NoGC Erl_ddll_info
instance Bif2 Erl_ddll_info
instance Bif_ Erl_ddll_info where bif_ arity _ = Import "erl_ddll" "info" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erl_ddll_format_error_int where bif_ arity _ = Import "erl_ddll" "format_error_int" arity ;{-# INLINE bif_ #-}

data Erl_ddll_monitor = Erl_ddll_monitor
instance NoGC Erl_ddll_monitor
instance Bif2 Erl_ddll_monitor
instance Bif_ Erl_ddll_monitor where bif_ arity _ = Import "erl_ddll" "monitor" arity ;{-# INLINE bif_ #-}

data Erl_ddll_demonitor = Erl_ddll_demonitor
instance NoGC Erl_ddll_demonitor
instance Bif1 Erl_ddll_demonitor
instance Bif_ Erl_ddll_demonitor where bif_ arity _ = Import "erl_ddll" "demonitor" arity ;{-# INLINE bif_ #-}

data Re_version = Re_version
instance NoGC Re_version
instance Bif0 Re_version
instance Bif_ Re_version where bif_ arity _ = Import "re" "version" arity ;{-# INLINE bif_ #-}

data Re_compile = Re_compile
instance NoGC Re_compile
instance Bif1 Re_compile
instance Bif2 Re_compile
instance Bif_ Re_compile where bif_ arity _ = Import "re" "compile" arity ;{-# INLINE bif_ #-}

data Re_run = Re_run
instance NoGC Re_run
instance Bif2 Re_run
instance Bif3 Re_run
instance Bif_ Re_run where bif_ arity _ = Import "re" "run" arity ;{-# INLINE bif_ #-}

data Lists_member = Lists_member
instance NoGC Lists_member
instance Bif2 Lists_member
instance Bif_ Lists_member where bif_ arity _ = Import "lists" "member" arity ;{-# INLINE bif_ #-}

data Lists_reverse = Lists_reverse
instance NoGC Lists_reverse
instance Bif2 Lists_reverse
instance Bif_ Lists_reverse where bif_ arity _ = Import "lists" "reverse" arity ;{-# INLINE bif_ #-}

data Lists_keymember = Lists_keymember
instance NoGC Lists_keymember
instance Bif3 Lists_keymember
instance Bif_ Lists_keymember where bif_ arity _ = Import "lists" "keymember" arity ;{-# INLINE bif_ #-}

data Lists_keysearch = Lists_keysearch
instance NoGC Lists_keysearch
instance Bif3 Lists_keysearch
instance Bif_ Lists_keysearch where bif_ arity _ = Import "lists" "keysearch" arity ;{-# INLINE bif_ #-}

data Lists_keyfind = Lists_keyfind
instance NoGC Lists_keyfind
instance Bif3 Lists_keyfind
instance Bif_ Lists_keyfind where bif_ arity _ = Import "lists" "keyfind" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_disassemble where bif_ arity _ = Import "erts_debug" "disassemble" arity ;{-# INLINE bif_ #-}

data Erts_debug_breakpoint = Erts_debug_breakpoint
instance NoGC Erts_debug_breakpoint
instance Bif2 Erts_debug_breakpoint
instance Bif_ Erts_debug_breakpoint where bif_ arity _ = Import "erts_debug" "breakpoint" arity ;{-# INLINE bif_ #-}

data Erts_debug_same = Erts_debug_same
instance NoGC Erts_debug_same
instance Bif2 Erts_debug_same
instance Bif_ Erts_debug_same where bif_ arity _ = Import "erts_debug" "same" arity ;{-# INLINE bif_ #-}

data Erts_debug_flat_size = Erts_debug_flat_size
instance NoGC Erts_debug_flat_size
instance Bif1 Erts_debug_flat_size
instance Bif_ Erts_debug_flat_size where bif_ arity _ = Import "erts_debug" "flat_size" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_get_internal_state where bif_ arity _ = Import "erts_debug" "get_internal_state" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_set_internal_state where bif_ arity _ = Import "erts_debug" "set_internal_state" arity ;{-# INLINE bif_ #-}

data Erts_debug_display = Erts_debug_display
instance NoGC Erts_debug_display
instance Bif1 Erts_debug_display
instance Bif_ Erts_debug_display where bif_ arity _ = Import "erts_debug" "display" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_dist_ext_to_term where bif_ arity _ = Import "erts_debug" "dist_ext_to_term" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_instructions where bif_ arity _ = Import "erts_debug" "instructions" arity ;{-# INLINE bif_ #-}

data Erts_debug_dirty_cpu = Erts_debug_dirty_cpu
instance NoGC Erts_debug_dirty_cpu
instance Bif2 Erts_debug_dirty_cpu
instance Bif_ Erts_debug_dirty_cpu where bif_ arity _ = Import "erts_debug" "dirty_cpu" arity ;{-# INLINE bif_ #-}

data Erts_debug_dirty_io = Erts_debug_dirty_io
instance NoGC Erts_debug_dirty_io
instance Bif2 Erts_debug_dirty_io
instance Bif_ Erts_debug_dirty_io where bif_ arity _ = Import "erts_debug" "dirty_io" arity ;{-# INLINE bif_ #-}

data Erts_debug_dirty = Erts_debug_dirty
instance NoGC Erts_debug_dirty
instance Bif3 Erts_debug_dirty
instance Bif_ Erts_debug_dirty where bif_ arity _ = Import "erts_debug" "dirty" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_dump_monitors where bif_ arity _ = Import "erts_debug" "dump_monitors" arity ;{-# INLINE bif_ #-}

data Erts_debug_dump_links = Erts_debug_dump_links
instance NoGC Erts_debug_dump_links
instance Bif1 Erts_debug_dump_links
instance Bif_ Erts_debug_dump_links where bif_ arity _ = Import "erts_debug" "dump_links" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_lcnt_control where bif_ arity _ = Import "erts_debug" "lcnt_control" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_lcnt_collect where bif_ arity _ = Import "erts_debug" "lcnt_collect" arity ;{-# INLINE bif_ #-}

data Erts_debug_lcnt_clear = Erts_debug_lcnt_clear
instance NoGC Erts_debug_lcnt_clear
instance Bif0 Erts_debug_lcnt_clear
instance Bif_ Erts_debug_lcnt_clear where bif_ arity _ = Import "erts_debug" "lcnt_clear" arity ;{-# INLINE bif_ #-}

data Code_get_chunk = Code_get_chunk
instance NoGC Code_get_chunk
instance Bif2 Code_get_chunk
instance Bif_ Code_get_chunk where bif_ arity _ = Import "code" "get_chunk" arity ;{-# INLINE bif_ #-}

data Code_module_md5 = Code_module_md5
instance NoGC Code_module_md5
instance Bif1 Code_module_md5
instance Bif_ Code_module_md5 where bif_ arity _ = Import "code" "module_md5" arity ;{-# INLINE bif_ #-}

data Code_make_stub_module = Code_make_stub_module
instance NoGC Code_make_stub_module
instance Bif3 Code_make_stub_module
instance Bif_ Code_make_stub_module where bif_ arity _ = Import "code" "make_stub_module" arity ;{-# INLINE bif_ #-}

data Code_is_module_native = Code_is_module_native
instance NoGC Code_is_module_native
instance Bif1 Code_is_module_native
instance Bif_ Code_is_module_native where bif_ arity _ = Import "code" "is_module_native" arity ;{-# INLINE bif_ #-}

data Erlang_hibernate = Erlang_hibernate
instance NoGC Erlang_hibernate
instance Bif3 Erlang_hibernate
instance Bif_ Erlang_hibernate where bif_ arity _ = Import "erlang" "hibernate" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Error_logger_warning_map where bif_ arity _ = Import "error_logger" "warning_map" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_get_module_info where bif_ arity _ = Import "erlang" "get_module_info" arity ;{-# INLINE bif_ #-}

data Erlang_is_boolean = Erlang_is_boolean
instance NoGC Erlang_is_boolean
instance Bif1 Erlang_is_boolean
instance Bif_ Erlang_is_boolean where bif_ arity _ = Import "erlang" "is_boolean" arity ;{-# INLINE bif_ #-}
...
instance Bif_ String_list_to_integer where bif_ arity _ = Import "string" "list_to_integer" arity ;{-# INLINE bif_ #-}

data String_list_to_float = String_list_to_float
instance NoGC String_list_to_float
instance Bif1 String_list_to_float
instance Bif_ String_list_to_float where bif_ arity _ = Import "string" "list_to_float" arity ;{-# INLINE bif_ #-}

data Erlang_make_fun = Erlang_make_fun
instance NoGC Erlang_make_fun
instance Bif3 Erlang_make_fun
instance Bif_ Erlang_make_fun where bif_ arity _ = Import "erlang" "make_fun" arity ;{-# INLINE bif_ #-}

data Erlang_iolist_size = Erlang_iolist_size
instance NoGC Erlang_iolist_size
instance Bif1 Erlang_iolist_size
instance Bif_ Erlang_iolist_size where bif_ arity _ = Import "erlang" "iolist_size" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_iolist_to_binary where bif_ arity _ = Import "erlang" "iolist_to_binary" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_list_to_existing_atom where bif_ arity _ = Import "erlang" "list_to_existing_atom" arity ;{-# INLINE bif_ #-}

data Erlang_is_bitstring = Erlang_is_bitstring
instance NoGC Erlang_is_bitstring
instance Bif1 Erlang_is_bitstring
instance Bif_ Erlang_is_bitstring where bif_ arity _ = Import "erlang" "is_bitstring" arity ;{-# INLINE bif_ #-}

data Erlang_tuple_size = Erlang_tuple_size
instance NoGC Erlang_tuple_size
instance Bif1 Erlang_tuple_size
instance Bif_ Erlang_tuple_size where bif_ arity _ = Import "erlang" "tuple_size" arity ;{-# INLINE bif_ #-}

data Erlang_byte_size = Erlang_byte_size
instance Bif1 Erlang_byte_size
instance Bif_ Erlang_byte_size where bif_ arity _ = Import "erlang" "byte_size" arity ;{-# INLINE bif_ #-}

data Erlang_bit_size = Erlang_bit_size
instance Bif1 Erlang_bit_size
instance Bif_ Erlang_bit_size where bif_ arity _ = Import "erlang" "bit_size" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_list_to_bitstring where bif_ arity _ = Import "erlang" "list_to_bitstring" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_bitstring_to_list where bif_ arity _ = Import "erlang" "bitstring_to_list" arity ;{-# INLINE bif_ #-}

data Ets_update_element = Ets_update_element
instance NoGC Ets_update_element
instance Bif3 Ets_update_element
instance Bif_ Ets_update_element where bif_ arity _ = Import "ets" "update_element" arity ;{-# INLINE bif_ #-}

data Erlang_decode_packet = Erlang_decode_packet
instance NoGC Erlang_decode_packet
instance Bif3 Erlang_decode_packet
instance Bif_ Erlang_decode_packet where bif_ arity _ = Import "erlang" "decode_packet" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Unicode_characters_to_binary where bif_ arity _ = Import "unicode" "characters_to_binary" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Unicode_characters_to_list where bif_ arity _ = Import "unicode" "characters_to_list" arity ;{-# INLINE bif_ #-}

data Unicode_bin_is_7bit = Unicode_bin_is_7bit
instance NoGC Unicode_bin_is_7bit
instance Bif1 Unicode_bin_is_7bit
instance Bif_ Unicode_bin_is_7bit where bif_ arity _ = Import "unicode" "bin_is_7bit" arity ;{-# INLINE bif_ #-}

data Erlang_atom_to_binary = Erlang_atom_to_binary
instance NoGC Erlang_atom_to_binary
instance Bif2 Erlang_atom_to_binary
instance Bif_ Erlang_atom_to_binary where bif_ arity _ = Import "erlang" "atom_to_binary" arity ;{-# INLINE bif_ #-}

data Erlang_binary_to_atom = Erlang_binary_to_atom
instance NoGC Erlang_binary_to_atom
instance Bif2 Erlang_binary_to_atom
instance Bif_ Erlang_binary_to_atom where bif_ arity _ = Import "erlang" "binary_to_atom" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_binary_to_existing_atom where bif_ arity _ = Import "erlang" "binary_to_existing_atom" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Net_kernel_dflag_unicode_io where bif_ arity _ = Import "net_kernel" "dflag_unicode_io" arity ;{-# INLINE bif_ #-}

data Ets_give_away = Ets_give_away
instance NoGC Ets_give_away
instance Bif3 Ets_give_away
instance Bif_ Ets_give_away where bif_ arity _ = Import "ets" "give_away" arity ;{-# INLINE bif_ #-}

data Ets_setopts = Ets_setopts
instance NoGC Ets_setopts
instance Bif2 Ets_setopts
instance Bif_ Ets_setopts where bif_ arity _ = Import "ets" "setopts" arity ;{-# INLINE bif_ #-}

data Erlang_load_nif = Erlang_load_nif
instance NoGC Erlang_load_nif
instance Bif2 Erlang_load_nif
instance Bif_ Erlang_load_nif where bif_ arity _ = Import "erlang" "load_nif" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_call_on_load_function where bif_ arity _ = Import "erlang" "call_on_load_function" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_finish_after_on_load where bif_ arity _ = Import "erlang" "finish_after_on_load" arity ;{-# INLINE bif_ #-}

data Erlang_binary_part = Erlang_binary_part
instance Bif2 Erlang_binary_part
instance Bif3 Erlang_binary_part
instance Bif_ Erlang_binary_part where bif_ arity _ = Import "erlang" "binary_part" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_compile_pattern where bif_ arity _ = Import "binary" "compile_pattern" arity ;{-# INLINE bif_ #-}

data Binary_match = Binary_match
instance NoGC Binary_match
instance Bif2 Binary_match
instance Bif3 Binary_match
instance Bif_ Binary_match where bif_ arity _ = Import "binary" "match" arity ;{-# INLINE bif_ #-}

data Binary_matches = Binary_matches
instance NoGC Binary_matches
instance Bif2 Binary_matches
instance Bif3 Binary_matches
instance Bif_ Binary_matches where bif_ arity _ = Import "binary" "matches" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_longest_common_prefix where bif_ arity _ = Import "binary" "longest_common_prefix" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_longest_common_suffix where bif_ arity _ = Import "binary" "longest_common_suffix" arity ;{-# INLINE bif_ #-}

data Binary_first = Binary_first
instance NoGC Binary_first
instance Bif1 Binary_first
instance Bif_ Binary_first where bif_ arity _ = Import "binary" "first" arity ;{-# INLINE bif_ #-}

data Binary_last = Binary_last
instance NoGC Binary_last
instance Bif1 Binary_last
instance Bif_ Binary_last where bif_ arity _ = Import "binary" "last" arity ;{-# INLINE bif_ #-}

data Binary_at = Binary_at
instance NoGC Binary_at
instance Bif2 Binary_at
instance Bif_ Binary_at where bif_ arity _ = Import "binary" "at" arity ;{-# INLINE bif_ #-}

data Binary_part = Binary_part
instance NoGC Binary_part
instance Bif2 Binary_part
instance Bif3 Binary_part
instance Bif_ Binary_part where bif_ arity _ = Import "binary" "part" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_bin_to_list where bif_ arity _ = Import "binary" "bin_to_list" arity ;{-# INLINE bif_ #-}

data Binary_copy = Binary_copy
instance NoGC Binary_copy
instance Bif1 Binary_copy
instance Bif2 Binary_copy
instance Bif_ Binary_copy where bif_ arity _ = Import "binary" "copy" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_referenced_byte_size where bif_ arity _ = Import "binary" "referenced_byte_size" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_encode_unsigned where bif_ arity _ = Import "binary" "encode_unsigned" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_decode_unsigned where bif_ arity _ = Import "binary" "decode_unsigned" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_nif_error where bif_ arity _ = Import "erlang" "nif_error" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_internal_name2native where bif_ arity _ = Import "prim_file" "internal_name2native" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_internal_native2name where bif_ arity _ = Import "prim_file" "internal_native2name" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_internal_normalize_utf8 where bif_ arity _ = Import "prim_file" "internal_normalize_utf8" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_is_translatable where bif_ arity _ = Import "prim_file" "is_translatable" arity ;{-# INLINE bif_ #-}
...
instance Bif_ File_native_name_encoding where bif_ arity _ = Import "file" "native_name_encoding" arity ;{-# INLINE bif_ #-}

data Erlang_check_old_code = Erlang_check_old_code
instance NoGC Erlang_check_old_code
instance Bif1 Erlang_check_old_code
instance Bif_ Erlang_check_old_code where bif_ arity _ = Import "erlang" "check_old_code" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_universaltime_to_posixtime where bif_ arity _ = Import "erlang" "universaltime_to_posixtime" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_posixtime_to_universaltime where bif_ arity _ = Import "erlang" "posixtime_to_universaltime" arity ;{-# INLINE bif_ #-}

data Erlang_dt_put_tag = Erlang_dt_put_tag
instance NoGC Erlang_dt_put_tag
instance Bif1 Erlang_dt_put_tag
instance Bif_ Erlang_dt_put_tag where bif_ arity _ = Import "erlang" "dt_put_tag" arity ;{-# INLINE bif_ #-}

data Erlang_dt_get_tag = Erlang_dt_get_tag
instance NoGC Erlang_dt_get_tag
instance Bif0 Erlang_dt_get_tag
instance Bif_ Erlang_dt_get_tag where bif_ arity _ = Import "erlang" "dt_get_tag" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dt_get_tag_data where bif_ arity _ = Import "erlang" "dt_get_tag_data" arity ;{-# INLINE bif_ #-}

data Erlang_dt_spread_tag = Erlang_dt_spread_tag
instance NoGC Erlang_dt_spread_tag
instance Bif1 Erlang_dt_spread_tag
instance Bif_ Erlang_dt_spread_tag where bif_ arity _ = Import "erlang" "dt_spread_tag" arity ;{-# INLINE bif_ #-}

data Erlang_dt_restore_tag = Erlang_dt_restore_tag
instance NoGC Erlang_dt_restore_tag
instance Bif1 Erlang_dt_restore_tag
instance Bif_ Erlang_dt_restore_tag where bif_ arity _ = Import "erlang" "dt_restore_tag" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dt_prepend_vm_tag_data where bif_ arity _ = Import "erlang" "dt_prepend_vm_tag_data" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dt_append_vm_tag_data where bif_ arity _ = Import "erlang" "dt_append_vm_tag_data" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_prepare_loading where bif_ arity _ = Import "erlang" "prepare_loading" arity ;{-# INLINE bif_ #-}

data Erlang_finish_loading = Erlang_finish_loading
instance NoGC Erlang_finish_loading
instance Bif1 Erlang_finish_loading
instance Bif_ Erlang_finish_loading where bif_ arity _ = Import "erlang" "finish_loading" arity ;{-# INLINE bif_ #-}

data Erlang_insert_element = Erlang_insert_element
instance NoGC Erlang_insert_element
instance Bif3 Erlang_insert_element
instance Bif_ Erlang_insert_element where bif_ arity _ = Import "erlang" "insert_element" arity ;{-# INLINE bif_ #-}

data Erlang_delete_element = Erlang_delete_element
instance NoGC Erlang_delete_element
instance Bif2 Erlang_delete_element
instance Bif_ Erlang_delete_element where bif_ arity _ = Import "erlang" "delete_element" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_binary_to_integer where bif_ arity _ = Import "erlang" "binary_to_integer" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_integer_to_binary where bif_ arity _ = Import "erlang" "integer_to_binary" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_float_to_binary where bif_ arity _ = Import "erlang" "float_to_binary" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_binary_to_float where bif_ arity _ = Import "erlang" "binary_to_float" arity ;{-# INLINE bif_ #-}

data Io_printable_range = Io_printable_range
instance NoGC Io_printable_range
instance Bif0 Io_printable_range
instance Bif_ Io_printable_range where bif_ arity _ = Import "io" "printable_range" arity ;{-# INLINE bif_ #-}

data Re_inspect = Re_inspect
instance NoGC Re_inspect
instance Bif2 Re_inspect
instance Bif_ Re_inspect where bif_ arity _ = Import "re" "inspect" arity ;{-# INLINE bif_ #-}

data Erlang_is_map = Erlang_is_map
instance NoGC Erlang_is_map
instance Bif1 Erlang_is_map
instance Bif_ Erlang_is_map where bif_ arity _ = Import "erlang" "is_map" arity ;{-# INLINE bif_ #-}

data Erlang_map_size = Erlang_map_size
instance Bif1 Erlang_map_size
instance Bif_ Erlang_map_size where bif_ arity _ = Import "erlang" "map_size" arity ;{-# INLINE bif_ #-}

data Maps_find = Maps_find
instance NoGC Maps_find
instance Bif2 Maps_find
instance Bif_ Maps_find where bif_ arity _ = Import "maps" "find" arity ;{-# INLINE bif_ #-}

data Maps_get = Maps_get
instance NoGC Maps_get
instance Bif2 Maps_get
instance Bif_ Maps_get where bif_ arity _ = Import "maps" "get" arity ;{-# INLINE bif_ #-}

data Maps_from_list = Maps_from_list
instance NoGC Maps_from_list
instance Bif1 Maps_from_list
instance Bif_ Maps_from_list where bif_ arity _ = Import "maps" "from_list" arity ;{-# INLINE bif_ #-}

data Maps_is_key = Maps_is_key
instance NoGC Maps_is_key
instance Bif2 Maps_is_key
instance Bif_ Maps_is_key where bif_ arity _ = Import "maps" "is_key" arity ;{-# INLINE bif_ #-}

data Maps_keys = Maps_keys
instance NoGC Maps_keys
instance Bif1 Maps_keys
instance Bif_ Maps_keys where bif_ arity _ = Import "maps" "keys" arity ;{-# INLINE bif_ #-}

data Maps_merge = Maps_merge
instance NoGC Maps_merge
instance Bif2 Maps_merge
instance Bif_ Maps_merge where bif_ arity _ = Import "maps" "merge" arity ;{-# INLINE bif_ #-}

data Maps_new = Maps_new
instance NoGC Maps_new
instance Bif0 Maps_new
instance Bif_ Maps_new where bif_ arity _ = Import "maps" "new" arity ;{-# INLINE bif_ #-}

data Maps_put = Maps_put
instance NoGC Maps_put
instance Bif3 Maps_put
instance Bif_ Maps_put where bif_ arity _ = Import "maps" "put" arity ;{-# INLINE bif_ #-}

data Maps_remove = Maps_remove
instance NoGC Maps_remove
instance Bif2 Maps_remove
instance Bif_ Maps_remove where bif_ arity _ = Import "maps" "remove" arity ;{-# INLINE bif_ #-}

data Maps_update = Maps_update
instance NoGC Maps_update
instance Bif3 Maps_update
instance Bif_ Maps_update where bif_ arity _ = Import "maps" "update" arity ;{-# INLINE bif_ #-}

data Maps_values = Maps_values
instance NoGC Maps_values
instance Bif1 Maps_values
instance Bif_ Maps_values where bif_ arity _ = Import "maps" "values" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_cmp_term where bif_ arity _ = Import "erts_internal" "cmp_term" arity ;{-# INLINE bif_ #-}

data Ets_take = Ets_take
instance NoGC Ets_take
instance Bif2 Ets_take
instance Bif_ Ets_take where bif_ arity _ = Import "ets" "take" arity ;{-# INLINE bif_ #-}

data Erlang_fun_info_mfa = Erlang_fun_info_mfa
instance NoGC Erlang_fun_info_mfa
instance Bif1 Erlang_fun_info_mfa
instance Bif_ Erlang_fun_info_mfa where bif_ arity _ = Import "erlang" "fun_info_mfa" arity ;{-# INLINE bif_ #-}

data Erts_debug_map_info = Erts_debug_map_info
instance NoGC Erts_debug_map_info
instance Bif1 Erts_debug_map_info
instance Bif_ Erts_debug_map_info where bif_ arity _ = Import "erts_debug" "map_info" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_is_process_executing_dirty where bif_ arity _ = Import "erts_internal" "is_process_executing_dirty" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_check_dirty_process_code where bif_ arity _ = Import "erts_internal" "check_dirty_process_code" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_purge_module where bif_ arity _ = Import "erts_internal" "purge_module" arity ;{-# INLINE bif_ #-}

data Binary_split = Binary_split
instance NoGC Binary_split
instance Bif2 Binary_split
instance Bif3 Binary_split
instance Bif_ Binary_split where bif_ arity _ = Import "binary" "split" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_size_shared where bif_ arity _ = Import "erts_debug" "size_shared" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_copy_shared where bif_ arity _ = Import "erts_debug" "copy_shared" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_has_prepared_code_on_load where bif_ arity _ = Import "erlang" "has_prepared_code_on_load" arity ;{-# INLINE bif_ #-}

data Maps_take = Maps_take
instance NoGC Maps_take
instance Bif2 Maps_take
instance Bif_ Maps_take where bif_ arity _ = Import "maps" "take" arity ;{-# INLINE bif_ #-}

data Erlang_floor = Erlang_floor
instance Bif1 Erlang_floor
instance Bif_ Erlang_floor where bif_ arity _ = Import "erlang" "floor" arity ;{-# INLINE bif_ #-}

data Erlang_ceil = Erlang_ceil
instance Bif1 Erlang_ceil
instance Bif_ Erlang_ceil where bif_ arity _ = Import "erlang" "ceil" arity ;{-# INLINE bif_ #-}

data Math_floor = Math_floor
instance NoGC Math_floor
instance Bif1 Math_floor
instance Bif_ Math_floor where bif_ arity _ = Import "math" "floor" arity ;{-# INLINE bif_ #-}

data Math_ceil = Math_ceil
instance NoGC Math_ceil
instance Bif1 Math_ceil
instance Bif_ Math_ceil where bif_ arity _ = Import "math" "ceil" arity ;{-# INLINE bif_ #-}

data Math_fmod = Math_fmod
instance NoGC Math_fmod
instance Bif2 Math_fmod
instance Bif_ Math_fmod where bif_ arity _ = Import "math" "fmod" arity ;{-# INLINE bif_ #-}

data Os_set_signal = Os_set_signal
instance NoGC Os_set_signal
instance Bif2 Os_set_signal
instance Bif_ Os_set_signal where bif_ arity _ = Import "os" "set_signal" arity ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_iolist_to_iovec where bif_ arity _ = Import "erlang" "iolist_to_iovec" arity ;{-# INLINE bif_ #-}
