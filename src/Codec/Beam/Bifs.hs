...
instance Bif_ Erlang_abs where bif_ _ = ("erlang", "abs") ;{-# INLINE bif_ #-}

data Erlang_adler32 = Erlang_adler32
instance NoGC Erlang_adler32
instance Bif1 Erlang_adler32
instance Bif2 Erlang_adler32
instance Bif_ Erlang_adler32 where bif_ _ = ("erlang", "adler32") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_adler32_combine where bif_ _ = ("erlang", "adler32_combine") ;{-# INLINE bif_ #-}

data Erlang_apply = Erlang_apply
instance NoGC Erlang_apply
instance Bif3 Erlang_apply
instance Bif_ Erlang_apply where bif_ _ = ("erlang", "apply") ;{-# INLINE bif_ #-}

data Erlang_atom_to_list = Erlang_atom_to_list
instance NoGC Erlang_atom_to_list
instance Bif1 Erlang_atom_to_list
instance Bif_ Erlang_atom_to_list where bif_ _ = ("erlang", "atom_to_list") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_binary_to_list where bif_ _ = ("erlang", "binary_to_list") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_external_size where bif_ _ = ("erlang", "external_size") ;{-# INLINE bif_ #-}

data Erlang_float = Erlang_float
instance Bif1 Erlang_float
instance Bif_ Erlang_float where bif_ _ = ("erlang", "float") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_float_to_list where bif_ _ = ("erlang", "float_to_list") ;{-# INLINE bif_ #-}

data Erlang_fun_info = Erlang_fun_info
instance NoGC Erlang_fun_info
instance Bif2 Erlang_fun_info
instance Bif_ Erlang_fun_info where bif_ _ = ("erlang", "fun_info") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_garbage_collect where bif_ _ = ("erts_internal", "garbage_collect") ;{-# INLINE bif_ #-}

data Erlang_get = Erlang_get
instance NoGC Erlang_get
instance Bif0 Erlang_get
instance Bif1 Erlang_get
instance Bif_ Erlang_get where bif_ _ = ("erlang", "get") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_get_keys where bif_ _ = ("erlang", "get_keys") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_localtime_to_universaltime where bif_ _ = ("erlang", "localtime_to_universaltime") ;{-# INLINE bif_ #-}

data Erlang_make_ref = Erlang_make_ref
instance NoGC Erlang_make_ref
instance Bif0 Erlang_make_ref
instance Bif_ Erlang_make_ref where bif_ _ = ("erlang", "make_ref") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_function_exported where bif_ _ = ("erlang", "function_exported") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_monitor_node where bif_ _ = ("erlang", "monitor_node") ;{-# INLINE bif_ #-}

data Erlang_node = Erlang_node
instance NoGC Erlang_node
instance Bif0 Erlang_node
instance Bif1 Erlang_node
instance Bif_ Erlang_node where bif_ _ = ("erlang", "node") ;{-# INLINE bif_ #-}

data Erlang_nodes = Erlang_nodes
instance NoGC Erlang_nodes
instance Bif1 Erlang_nodes
instance Bif_ Erlang_nodes where bif_ _ = ("erlang", "nodes") ;{-# INLINE bif_ #-}

data Erlang_now = Erlang_now
instance NoGC Erlang_now
instance Bif0 Erlang_now
instance Bif_ Erlang_now where bif_ _ = ("erlang", "now") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_monotonic_time where bif_ _ = ("erlang", "monotonic_time") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_system_time where bif_ _ = ("erlang", "system_time") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_time_offset where bif_ _ = ("erlang", "time_offset") ;{-# INLINE bif_ #-}

data Erlang_timestamp = Erlang_timestamp
instance NoGC Erlang_timestamp
instance Bif0 Erlang_timestamp
instance Bif_ Erlang_timestamp where bif_ _ = ("erlang", "timestamp") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_open_port where bif_ _ = ("erts_internal", "open_port") ;{-# INLINE bif_ #-}

data Erlang_pid_to_list = Erlang_pid_to_list
instance NoGC Erlang_pid_to_list
instance Bif1 Erlang_pid_to_list
instance Bif_ Erlang_pid_to_list where bif_ _ = ("erlang", "pid_to_list") ;{-# INLINE bif_ #-}

data Erlang_ports = Erlang_ports
instance NoGC Erlang_ports
instance Bif0 Erlang_ports
instance Bif_ Erlang_ports where bif_ _ = ("erlang", "ports") ;{-# INLINE bif_ #-}

data Erlang_pre_loaded = Erlang_pre_loaded
instance NoGC Erlang_pre_loaded
instance Bif0 Erlang_pre_loaded
instance Bif_ Erlang_pre_loaded where bif_ _ = ("erlang", "pre_loaded") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_process_flag where bif_ _ = ("erlang", "process_flag") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_input_handler where bif_ _ = ("erlang", "dist_ctrl_input_handler") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_put_data where bif_ _ = ("erlang", "dist_ctrl_put_data") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_get_data where bif_ _ = ("erlang", "dist_ctrl_get_data") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dist_ctrl_get_data_notification where bif_ _ = ("erlang", "dist_ctrl_get_data_notification") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_info where bif_ _ = ("erts_internal", "port_info") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_call where bif_ _ = ("erts_internal", "port_call") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_command where bif_ _ = ("erts_internal", "port_command") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_control where bif_ _ = ("erts_internal", "port_control") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_close where bif_ _ = ("erts_internal", "port_close") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_port_connect where bif_ _ = ("erts_internal", "port_connect") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_request_system_task where bif_ _ = ("erts_internal", "request_system_task") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_check_process_code where bif_ _ = ("erts_internal", "check_process_code") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_map_to_tuple_keys where bif_ _ = ("erts_internal", "map_to_tuple_keys") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_term_type where bif_ _ = ("erts_internal", "term_type") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_map_hashmap_children where bif_ _ = ("erts_internal", "map_hashmap_children") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_time_unit where bif_ _ = ("erts_internal", "time_unit") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_perf_counter_unit where bif_ _ = ("erts_internal", "perf_counter_unit") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_is_system_process where bif_ _ = ("erts_internal", "is_system_process") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_system_check where bif_ _ = ("erts_internal", "system_check") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_release_literal_area_switch where bif_ _ = ("erts_internal", "release_literal_area_switch") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_scheduler_wall_time where bif_ _ = ("erts_internal", "scheduler_wall_time") ;{-# INLINE bif_ #-}

data Erlang_port_set_data = Erlang_port_set_data
instance NoGC Erlang_port_set_data
instance Bif2 Erlang_port_set_data
instance Bif_ Erlang_port_set_data where bif_ _ = ("erlang", "port_set_data") ;{-# INLINE bif_ #-}

data Erlang_port_get_data = Erlang_port_get_data
instance NoGC Erlang_port_get_data
instance Bif1 Erlang_port_get_data
instance Bif_ Erlang_port_get_data where bif_ _ = ("erlang", "port_get_data") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_trace_pattern where bif_ _ = ("erts_internal", "trace_pattern") ;{-# INLINE bif_ #-}

data Erts_internal_trace = Erts_internal_trace
instance NoGC Erts_internal_trace
instance Bif3 Erts_internal_trace
instance Bif_ Erts_internal_trace where bif_ _ = ("erts_internal", "trace") ;{-# INLINE bif_ #-}

data Erlang_trace_info = Erlang_trace_info
instance NoGC Erlang_trace_info
instance Bif2 Erlang_trace_info
instance Bif_ Erlang_trace_info where bif_ _ = ("erlang", "trace_info") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_trace_delivered where bif_ _ = ("erlang", "trace_delivered") ;{-# INLINE bif_ #-}

data Erlang_seq_trace = Erlang_seq_trace
instance NoGC Erlang_seq_trace
instance Bif2 Erlang_seq_trace
instance Bif_ Erlang_seq_trace where bif_ _ = ("erlang", "seq_trace") ;{-# INLINE bif_ #-}

data Erlang_seq_trace_info = Erlang_seq_trace_info
instance NoGC Erlang_seq_trace_info
instance Bif1 Erlang_seq_trace_info
instance Bif_ Erlang_seq_trace_info where bif_ _ = ("erlang", "seq_trace_info") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_seq_trace_print where bif_ _ = ("erlang", "seq_trace_print") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_suspend_process where bif_ _ = ("erlang", "suspend_process") ;{-# INLINE bif_ #-}

data Erlang_resume_process = Erlang_resume_process
instance NoGC Erlang_resume_process
instance Bif1 Erlang_resume_process
instance Bif_ Erlang_resume_process where bif_ _ = ("erlang", "resume_process") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_process_display where bif_ _ = ("erlang", "process_display") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_start_timer where bif_ _ = ("erlang", "start_timer") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_send_after where bif_ _ = ("erlang", "send_after") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_cancel_timer where bif_ _ = ("erlang", "cancel_timer") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_read_timer where bif_ _ = ("erlang", "read_timer") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_system_monitor where bif_ _ = ("erlang", "system_monitor") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_demonitor where bif_ _ = ("erlang", "demonitor") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_ebif_plusplus_2 where bif_ _ = ("erlang", "++") ;{-# INLINE bif_ #-}

data Erlang_append = Erlang_append
instance NoGC Erlang_append
instance Bif2 Erlang_append
instance Bif_ Erlang_append where bif_ _ = ("erlang", "append") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_is_function where bif_ _ = ("erlang", "is_function") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_is_record where bif_ _ = ("erlang", "is_record") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_match_spec_test where bif_ _ = ("erlang", "match_spec_test") ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_internal_request_all where bif_ _ = ("ets", "internal_request_all") ;{-# INLINE bif_ #-}

data Ets_new = Ets_new
instance NoGC Ets_new
instance Bif2 Ets_new
instance Bif_ Ets_new where bif_ _ = ("ets", "new") ;{-# INLINE bif_ #-}

data Ets_delete = Ets_delete
instance NoGC Ets_delete
instance Bif1 Ets_delete
instance Bif2 Ets_delete
instance Bif_ Ets_delete where bif_ _ = ("ets", "delete") ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_match where bif_ _ = ("ets", "match") ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_update_counter where bif_ _ = ("ets", "update_counter") ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_select where bif_ _ = ("ets", "select") ;{-# INLINE bif_ #-}

data Ets_select_count = Ets_select_count
instance NoGC Ets_select_count
instance Bif2 Ets_select_count
instance Bif_ Ets_select_count where bif_ _ = ("ets", "select_count") ;{-# INLINE bif_ #-}
...
instance Bif_ Ets_select_reverse where bif_ _ = ("ets", "select_reverse") ;{-# INLINE bif_ #-}

data Ets_select_delete = Ets_select_delete
instance NoGC Ets_select_delete
instance Bif2 Ets_select_delete
instance Bif_ Ets_select_delete where bif_ _ = ("ets", "select_delete") ;{-# INLINE bif_ #-}

data Ets_select_replace = Ets_select_replace
instance NoGC Ets_select_replace
instance Bif2 Ets_select_replace
instance Bif_ Ets_select_replace where bif_ _ = ("ets", "select_replace") ;{-# INLINE bif_ #-}
...
instance Bif_ Erl_ddll_loaded_drivers where bif_ _ = ("erl_ddll", "loaded_drivers") ;{-# INLINE bif_ #-}

data Erl_ddll_info = Erl_ddll_info
instance NoGC Erl_ddll_info
instance Bif2 Erl_ddll_info
instance Bif_ Erl_ddll_info where bif_ _ = ("erl_ddll", "info") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_get_internal_state where bif_ _ = ("erts_debug", "get_internal_state") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_set_internal_state where bif_ _ = ("erts_debug", "set_internal_state") ;{-# INLINE bif_ #-}

data Erts_debug_display = Erts_debug_display
instance NoGC Erts_debug_display
instance Bif1 Erts_debug_display
instance Bif_ Erts_debug_display where bif_ _ = ("erts_debug", "display") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_dist_ext_to_term where bif_ _ = ("erts_debug", "dist_ext_to_term") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_dump_monitors where bif_ _ = ("erts_debug", "dump_monitors") ;{-# INLINE bif_ #-}

data Erts_debug_dump_links = Erts_debug_dump_links
instance NoGC Erts_debug_dump_links
instance Bif1 Erts_debug_dump_links
instance Bif_ Erts_debug_dump_links where bif_ _ = ("erts_debug", "dump_links") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_lcnt_control where bif_ _ = ("erts_debug", "lcnt_control") ;{-# INLINE bif_ #-}
...
instance Bif_ Error_logger_warning_map where bif_ _ = ("error_logger", "warning_map") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_get_module_info where bif_ _ = ("erlang", "get_module_info") ;{-# INLINE bif_ #-}

data Erlang_is_boolean = Erlang_is_boolean
instance NoGC Erlang_is_boolean
instance Bif1 Erlang_is_boolean
instance Bif_ Erlang_is_boolean where bif_ _ = ("erlang", "is_boolean") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_iolist_to_binary where bif_ _ = ("erlang", "iolist_to_binary") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_list_to_existing_atom where bif_ _ = ("erlang", "list_to_existing_atom") ;{-# INLINE bif_ #-}

data Erlang_is_bitstring = Erlang_is_bitstring
instance NoGC Erlang_is_bitstring
instance Bif1 Erlang_is_bitstring
instance Bif_ Erlang_is_bitstring where bif_ _ = ("erlang", "is_bitstring") ;{-# INLINE bif_ #-}

data Erlang_tuple_size = Erlang_tuple_size
instance NoGC Erlang_tuple_size
instance Bif1 Erlang_tuple_size
instance Bif_ Erlang_tuple_size where bif_ _ = ("erlang", "tuple_size") ;{-# INLINE bif_ #-}

data Erlang_byte_size = Erlang_byte_size
instance Bif1 Erlang_byte_size
instance Bif_ Erlang_byte_size where bif_ _ = ("erlang", "byte_size") ;{-# INLINE bif_ #-}

data Erlang_bit_size = Erlang_bit_size
instance Bif1 Erlang_bit_size
instance Bif_ Erlang_bit_size where bif_ _ = ("erlang", "bit_size") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_list_to_bitstring where bif_ _ = ("erlang", "list_to_bitstring") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_bitstring_to_list where bif_ _ = ("erlang", "bitstring_to_list") ;{-# INLINE bif_ #-}

data Ets_update_element = Ets_update_element
instance NoGC Ets_update_element
instance Bif3 Ets_update_element
instance Bif_ Ets_update_element where bif_ _ = ("ets", "update_element") ;{-# INLINE bif_ #-}

data Erlang_decode_packet = Erlang_decode_packet
instance NoGC Erlang_decode_packet
instance Bif3 Erlang_decode_packet
instance Bif_ Erlang_decode_packet where bif_ _ = ("erlang", "decode_packet") ;{-# INLINE bif_ #-}
...
instance Bif_ Unicode_characters_to_binary where bif_ _ = ("unicode", "characters_to_binary") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_binary_to_existing_atom where bif_ _ = ("erlang", "binary_to_existing_atom") ;{-# INLINE bif_ #-}
...
instance Bif_ Net_kernel_dflag_unicode_io where bif_ _ = ("net_kernel", "dflag_unicode_io") ;{-# INLINE bif_ #-}

data Ets_give_away = Ets_give_away
instance NoGC Ets_give_away
instance Bif3 Ets_give_away
instance Bif_ Ets_give_away where bif_ _ = ("ets", "give_away") ;{-# INLINE bif_ #-}

data Ets_setopts = Ets_setopts
instance NoGC Ets_setopts
instance Bif2 Ets_setopts
instance Bif_ Ets_setopts where bif_ _ = ("ets", "setopts") ;{-# INLINE bif_ #-}

data Erlang_load_nif = Erlang_load_nif
instance NoGC Erlang_load_nif
instance Bif2 Erlang_load_nif
instance Bif_ Erlang_load_nif where bif_ _ = ("erlang", "load_nif") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_call_on_load_function where bif_ _ = ("erlang", "call_on_load_function") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_finish_after_on_load where bif_ _ = ("erlang", "finish_after_on_load") ;{-# INLINE bif_ #-}

data Erlang_binary_part = Erlang_binary_part
instance Bif2 Erlang_binary_part
instance Bif3 Erlang_binary_part
instance Bif_ Erlang_binary_part where bif_ _ = ("erlang", "binary_part") ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_longest_common_prefix where bif_ _ = ("binary", "longest_common_prefix") ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_longest_common_suffix where bif_ _ = ("binary", "longest_common_suffix") ;{-# INLINE bif_ #-}

data Binary_first = Binary_first
instance NoGC Binary_first
instance Bif1 Binary_first
instance Bif_ Binary_first where bif_ _ = ("binary", "first") ;{-# INLINE bif_ #-}

data Binary_last = Binary_last
instance NoGC Binary_last
instance Bif1 Binary_last
instance Bif_ Binary_last where bif_ _ = ("binary", "last") ;{-# INLINE bif_ #-}

data Binary_at = Binary_at
instance NoGC Binary_at
instance Bif2 Binary_at
instance Bif_ Binary_at where bif_ _ = ("binary", "at") ;{-# INLINE bif_ #-}

data Binary_part = Binary_part
instance NoGC Binary_part
instance Bif2 Binary_part
instance Bif3 Binary_part
instance Bif_ Binary_part where bif_ _ = ("binary", "part") ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_bin_to_list where bif_ _ = ("binary", "bin_to_list") ;{-# INLINE bif_ #-}

data Binary_copy = Binary_copy
instance NoGC Binary_copy
instance Bif1 Binary_copy
instance Bif2 Binary_copy
instance Bif_ Binary_copy where bif_ _ = ("binary", "copy") ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_referenced_byte_size where bif_ _ = ("binary", "referenced_byte_size") ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_encode_unsigned where bif_ _ = ("binary", "encode_unsigned") ;{-# INLINE bif_ #-}
...
instance Bif_ Binary_decode_unsigned where bif_ _ = ("binary", "decode_unsigned") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_nif_error where bif_ _ = ("erlang", "nif_error") ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_internal_name2native where bif_ _ = ("prim_file", "internal_name2native") ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_internal_native2name where bif_ _ = ("prim_file", "internal_native2name") ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_internal_normalize_utf8 where bif_ _ = ("prim_file", "internal_normalize_utf8") ;{-# INLINE bif_ #-}
...
instance Bif_ Prim_file_is_translatable where bif_ _ = ("prim_file", "is_translatable") ;{-# INLINE bif_ #-}
...
instance Bif_ File_native_name_encoding where bif_ _ = ("file", "native_name_encoding") ;{-# INLINE bif_ #-}

data Erlang_check_old_code = Erlang_check_old_code
instance NoGC Erlang_check_old_code
instance Bif1 Erlang_check_old_code
instance Bif_ Erlang_check_old_code where bif_ _ = ("erlang", "check_old_code") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_universaltime_to_posixtime where bif_ _ = ("erlang", "universaltime_to_posixtime") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_posixtime_to_universaltime where bif_ _ = ("erlang", "posixtime_to_universaltime") ;{-# INLINE bif_ #-}

data Erlang_dt_put_tag = Erlang_dt_put_tag
instance NoGC Erlang_dt_put_tag
instance Bif1 Erlang_dt_put_tag
instance Bif_ Erlang_dt_put_tag where bif_ _ = ("erlang", "dt_put_tag") ;{-# INLINE bif_ #-}

data Erlang_dt_get_tag = Erlang_dt_get_tag
instance NoGC Erlang_dt_get_tag
instance Bif0 Erlang_dt_get_tag
instance Bif_ Erlang_dt_get_tag where bif_ _ = ("erlang", "dt_get_tag") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dt_get_tag_data where bif_ _ = ("erlang", "dt_get_tag_data") ;{-# INLINE bif_ #-}

data Erlang_dt_spread_tag = Erlang_dt_spread_tag
instance NoGC Erlang_dt_spread_tag
instance Bif1 Erlang_dt_spread_tag
instance Bif_ Erlang_dt_spread_tag where bif_ _ = ("erlang", "dt_spread_tag") ;{-# INLINE bif_ #-}

data Erlang_dt_restore_tag = Erlang_dt_restore_tag
instance NoGC Erlang_dt_restore_tag
instance Bif1 Erlang_dt_restore_tag
instance Bif_ Erlang_dt_restore_tag where bif_ _ = ("erlang", "dt_restore_tag") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dt_prepend_vm_tag_data where bif_ _ = ("erlang", "dt_prepend_vm_tag_data") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_dt_append_vm_tag_data where bif_ _ = ("erlang", "dt_append_vm_tag_data") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_binary_to_integer where bif_ _ = ("erlang", "binary_to_integer") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_integer_to_binary where bif_ _ = ("erlang", "integer_to_binary") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_float_to_binary where bif_ _ = ("erlang", "float_to_binary") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_cmp_term where bif_ _ = ("erts_internal", "cmp_term") ;{-# INLINE bif_ #-}

data Ets_take = Ets_take
instance NoGC Ets_take
instance Bif2 Ets_take
instance Bif_ Ets_take where bif_ _ = ("ets", "take") ;{-# INLINE bif_ #-}

data Erlang_fun_info_mfa = Erlang_fun_info_mfa
instance NoGC Erlang_fun_info_mfa
instance Bif1 Erlang_fun_info_mfa
instance Bif_ Erlang_fun_info_mfa where bif_ _ = ("erlang", "fun_info_mfa") ;{-# INLINE bif_ #-}

data Erts_debug_map_info = Erts_debug_map_info
instance NoGC Erts_debug_map_info
instance Bif1 Erts_debug_map_info
instance Bif_ Erts_debug_map_info where bif_ _ = ("erts_debug", "map_info") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_is_process_executing_dirty where bif_ _ = ("erts_internal", "is_process_executing_dirty") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_check_dirty_process_code where bif_ _ = ("erts_internal", "check_dirty_process_code") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_internal_purge_module where bif_ _ = ("erts_internal", "purge_module") ;{-# INLINE bif_ #-}

data Binary_split = Binary_split
instance NoGC Binary_split
instance Bif2 Binary_split
instance Bif3 Binary_split
instance Bif_ Binary_split where bif_ _ = ("binary", "split") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_size_shared where bif_ _ = ("erts_debug", "size_shared") ;{-# INLINE bif_ #-}
...
instance Bif_ Erts_debug_copy_shared where bif_ _ = ("erts_debug", "copy_shared") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_has_prepared_code_on_load where bif_ _ = ("erlang", "has_prepared_code_on_load") ;{-# INLINE bif_ #-}

data Maps_take = Maps_take
instance NoGC Maps_take
instance Bif2 Maps_take
instance Bif_ Maps_take where bif_ _ = ("maps", "take") ;{-# INLINE bif_ #-}

data Erlang_floor = Erlang_floor
instance Bif1 Erlang_floor
instance Bif_ Erlang_floor where bif_ _ = ("erlang", "floor") ;{-# INLINE bif_ #-}

data Erlang_ceil = Erlang_ceil
instance Bif1 Erlang_ceil
instance Bif_ Erlang_ceil where bif_ _ = ("erlang", "ceil") ;{-# INLINE bif_ #-}

data Math_floor = Math_floor
instance NoGC Math_floor
instance Bif1 Math_floor
instance Bif_ Math_floor where bif_ _ = ("math", "floor") ;{-# INLINE bif_ #-}

data Math_ceil = Math_ceil
instance NoGC Math_ceil
instance Bif1 Math_ceil
instance Bif_ Math_ceil where bif_ _ = ("math", "ceil") ;{-# INLINE bif_ #-}

data Math_fmod = Math_fmod
instance NoGC Math_fmod
instance Bif2 Math_fmod
instance Bif_ Math_fmod where bif_ _ = ("math", "fmod") ;{-# INLINE bif_ #-}

data Os_set_signal = Os_set_signal
instance NoGC Os_set_signal
instance Bif2 Os_set_signal
instance Bif_ Os_set_signal where bif_ _ = ("os", "set_signal") ;{-# INLINE bif_ #-}
...
instance Bif_ Erlang_iolist_to_iovec where bif_ _ = ("erlang", "iolist_to_iovec") ;{-# INLINE bif_ #-}

data Erts_internal_new_connection = Erts_internal_new_connection
instance NoGC Erts_internal_new_connection
instance Bif1 Erts_internal_new_connection
instance Bif_ Erts_internal_new_connection where bif_ _ = ("erts_internal", "new_connection") ;{-# INLINE bif_ #-}

data Erts_internal_abort_connection = Erts_internal_abort_connection
instance NoGC Erts_internal_abort_connection
instance Bif2 Erts_internal_abort_connection
instance Bif_ Erts_internal_abort_connection where bif_ _ = ("erts_internal", "abort_connection") ;{-# INLINE bif_ #-}

data Erts_internal_map_next = Erts_internal_map_next
instance NoGC Erts_internal_map_next
instance Bif3 Erts_internal_map_next
instance Bif_ Erts_internal_map_next where bif_ _ = ("erts_internal", "map_next") ;{-# INLINE bif_ #-}
